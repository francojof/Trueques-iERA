...
public class SaveBarterDtoReq {
    ...
    private Long idFirstOfferPostDtoReq;    //id foreign key
    ...
    public Long getIdFirstOfferPostDtoReq() {
        return idFirstOfferPostDtoReq;
    }

    public void setIdFirstOfferPostDtoReq(Long idFirstOfferPostDtoReq) {
        this.idFirstOfferPostDtoReq = idFirstOfferPostDtoReq;
    }
}
